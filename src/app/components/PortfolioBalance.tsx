...
function TokenBalance({ token, address }: { token: any, address: `0x${string}` | undefined }) {
  ...
  return (
    <div className="flex items-center p-3 bg-gray-500 dark:bg-gray-800/50 rounded-lg">
      <div 
